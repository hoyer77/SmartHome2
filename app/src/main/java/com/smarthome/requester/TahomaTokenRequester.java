...
public class TahomaTokenRequester {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>(){
                    ...
                    public void onResponse(String response) {
                        ...
                        new TahomaTokenRequester(appContext).getToken(new TahomaTokenRequester.VolleyResponseListenerTahoma() {
                ...
                new Response.ErrorListener(){
                    ...
                    public void onErrorResponse(VolleyError error) {
                        volleyResponseListenerTahoma.onError("");
                    }
                })
        {
    ...
    public void getToken(VolleyResponseListenerTahoma volleyResponseListenerTahoma, String JSessionID) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                new TahomaTokenRequester(appContext).registrationToken(new TahomaTokenRequester.VolleyResponseListenerTahoma() {
    ...
    public void registrationToken(VolleyResponseListenerTahoma volleyResponseListenerTahoma, String JSessionID, String token) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(postParam), new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                    volleyResponseListenerTahoma.onResponse(response.toString());
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
